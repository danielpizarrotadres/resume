	...
	\item
	      ...
	      \begin{itemize*}
        	...
        	\item Estabilización MMB y check-in
    	      \item Cambio de PSS Host de Raddix a Sabre, discovery de APIS, Check-in, Estado de vuelo, MMB (Cut over)
	      	\item Desarrollo de auto atencion por afectación de vuelos
	      	\item Desarrollo de check-in automático (proyecto estratégico con PSS Raddix)
    	      \item Migración a microservicios (Servicio de obtención de reservas, servicio de check-in, algoritmo de asignación de asientos con PSS Raddix)
	      \end{itemize*}
