...
\begin{itemize}[leftmargin=1em]
	...
	\item
	      ...
	      \begin{itemize*}
            \item TODO
    	      \item Como desarrollador participé en la implementación de una nueva arquitectura basada en microservicios comunicados por eventos asíncronos. Colaboré con la migración de los dominios de check-in, gestión de reservas y servicios que estaban alojados en 
	      \end{itemize*}
