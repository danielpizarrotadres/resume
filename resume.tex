	...
	\item
	      ...
	      \begin{itemize*}
        	...
        	\item Estabilización MMB y check-in
    	      ...
    	      \item Como desarrollador participé en la implementación de una nueva arquitectura basada en microservicios comunicados por eventos asíncronos. Colaboré con la migración de los dominios de check-in, gestión de reservas y servicios.
	      \end{itemize*}
